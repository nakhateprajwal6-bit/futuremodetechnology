  ...
  return (
    <div className="max-h-[80vh] overflow-y-auto p-4 space-y-6">
      ...
      <p className="text-gray-700 dark:text-gray-300 mb-4">
        At Future Mode Technology, we value your privacy and are committed to
      ...
      <div className="space-y-4">
        <section>
          ...
          <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2">
            ...
            <li>
              Usage data including login activity, course participation, and
              preferences.
            </li>
            <li>
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2">
            <li>
              To provide you with personalized educational services and course
              recommendations.
            </li>
            <li>
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300">
            ...
            secure access protocols, to protect your information from
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300">
            ...
            except for trusted partners involved in payment processing and
            educational services, and only when necessary.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2">
            ...
            <li>
              You can opt-out of promotional emails and notifications at any
              time.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300">
            ...
            services or legal requirements. We encourage you to review this page
            regularly.
          </p>
        </section>
