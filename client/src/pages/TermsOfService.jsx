  ...
  return (
    <div className="max-h-[80vh] overflow-y-auto p-4 space-y-6">
      ...
      <p className="text-gray-700 dark:text-gray-300 mb-4">
        Welcome to Future Mode Technology! These Terms of Service outline the
        rules and regulations for using our platform and services. By accessing
      ...
      <div className="space-y-4">
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300">
            We offer educational programs, resources, and training services
            aimed at enhancing technical skills and knowledge. All services are
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300">
            All content, materials, and software on this platform are the
            property of Future Mode Technology or its licensors. Unauthorized
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300">
            Payments for courses and services must be made through authorized
            payment providers. Refund requests are subject to our refund policy
            and must be initiated within the specified time frame.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300">
            ...
            arising from the use of our services. Users are responsible for
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300">
            ...
            at any time for violations of these terms or any unlawful
            activities.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300">
            We may update or revise these terms periodically. Continued use of
